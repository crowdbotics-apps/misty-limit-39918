"""
Django settings for misty_limit_39918 project.
...
ROOT_URLCONF = 'misty_limit_39918.urls'
...
WSGI_APPLICATION = 'misty_limit_39918.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_limit_39918 API",
    "DESCRIPTION": "API documentation for misty_limit_39918 App",
    "VERSION": "v1",
}
